        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
          ...
          <div className="space-y-6">
            <Link to="/" className="flex items-center gap-2">
              ...
              <span className="font-bold text-xl text-white tracking-tight">Online Auto Claimsline</span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <Link to="/commercial-insurance" className="flex items-center hover:text-white transition-colors group">
                  <ArrowRight size={14} className="mr-2 opacity-0 -ml-5 group-hover:opacity-100 group-hover:ml-0 transition-all duration-300 text-[#FF6B35]" />
            ...
            <ul className="space-y-6">
              <li className="flex items-start gap-4 group">
                ...
                <div>
                  ...
                  <a href={phoneTel} className="text-white font-bold text-lg hover:text-[#FF6B35] transition-colors">{phoneDisplay}</a>
                </div>
              </li>
              <li className="flex items-start gap-4 group">
                <div className="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center shrink-0 group-hover:bg-[#FF6B35]/20 transition-colors">
        ...
        <div className="space-y-6">
          <div className="border-t border-b border-white/10 py-6 mt-10">
            ...
            <p className="text-sm font-medium text-gray-200 mb-1">
              Online Auto Claimsline is operated by Online Auto Claimsline LTD
            </p>
          ...
          <div className="pb-6 border-b border-white/10">
            ...
            <p className="text-xs text-gray-500 leading-relaxed mb-4">
              ADVERTISEMENT: This website is a paid advertisement operated by Online Auto Claimsline LTD (Company No. 17095931). Online Auto Claimsline is not a law firm, a lawyer referral service, or an insurance provider. We do not provide legal advice, medical advice, or insurance adjusting services. You may request free information about an attorney's background and experience. Individuals appearing on this website may be paid actors or spokespersons and not actual attorneys. Any depictions of accidents or consultations are dramatizations. Use of this site, our forms, or our phone lines does not create an attorney-client relationship.
            </p>
            <p className="text-xs text-gray-500 leading-relaxed">
              FOR NORTH CAROLINA RESIDENTS: Online Auto Claimsline is a legal advertising service. We do not offer legal services or representation. Legal services are available only through independent attorneys licensed to practice law in North Carolina. Contacting us does not create an attorney-client relationship.
            </p>
          </div>

          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-600">
            <p>&copy; 2026 Online Auto Claimsline. All rights reserved.</p>

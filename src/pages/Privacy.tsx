          ...
          <section id="not-law-firm">
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-5 mb-4">
              <p className="leading-relaxed font-medium text-yellow-800 text-sm">
                <strong>Important Disclosure:</strong> Online Auto Claimsline is not a law firm, a lawyer referral service, or an insurance company. We do not provide legal advice, mediation, or insurance adjusting services.
              </p>
            </div>
            <p className="leading-relaxed">
          ...
          <section id="tcpa">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-5">
              <p className="leading-relaxed text-blue-900 text-sm">
                By providing your telephone number on our Site and/or initiating a call to our phone lines, you provide "prior express written consent" to be contacted by Online Auto Claimsline and our designated Marketing Partners via live calls, artificial/synthesized voice, pre-recorded messages, and/or SMS text messages delivered via automated technology. You provide this consent even if your number is listed on any State or Federal Do-Not-Call list.
              </p>
            </div>
          </section>

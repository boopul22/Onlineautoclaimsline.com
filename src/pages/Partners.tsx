        ...
        <div className="prose prose-lg max-w-none text-gray-600 space-y-10">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
            <p className="leading-relaxed text-yellow-800 text-sm">
              Autoclaimfiling.online is a legal advertising service that connects consumers with independent attorneys. Autoclaimfiling.online is not a law firm, does not provide legal advice, and does not endorse or recommend any attorney. No attorney-client relationship is formed by using this website or its services. Past results do not guarantee future outcomes. These attorneys participate in the Autoclaimfiling.online advertising program and have paid for promotional placement on this site. Selection of an attorney is solely at the consumer's discretion.
            </p>
          </div>
          ...
          <section>
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-5">
              <p className="text-blue-900 text-sm leading-relaxed">
                <strong>Note:</strong> Autoclaimfiling.online does not determine which attorney will handle a specific case. You have the right to choose any attorney, including those not affiliated with this program.
              </p>
            </div>
          </section>
